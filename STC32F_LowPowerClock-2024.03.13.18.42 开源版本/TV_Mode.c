...
u16 Time_comparison()
{
    ...
    {
        if(New_time_num[0] != Low_time_num[0])  j |= 0x0002;
        if(New_time_num[1] != Low_time_num[1])  j |= 0x0001;
    }

    if(Time_New[1] != Time_Low[1])
    {
        if(New_time_num[2] != Low_time_num[2])  j |= 0x0008;
        if(New_time_num[3] != Low_time_num[3])  j |= 0x0004;
    }

    if(Time_New[2] != Time_Low[2])
    {
        if(New_time_num[4] != Low_time_num[4])  j |= 0x0020;
        if(New_time_num[5] != Low_time_num[5])  j |= 0x0010;
    }
        ...
        if((dat00[0x0000] & 0x0008) && (a == 3) && (dat00[0x0010] >= 0x0020 &&  dat00[0x0010] <= 0x0022) && dat00[0x1A] == 0)
        {
            ...
            if(dat00[0x0010] == 0x0020)													//如果是时间显示页面
            {
                if(dat00[0x002D] >= DA)													//时间显示页面到达指定的时间
                {
                    ...
                    if((dat00[0x37] > 0) && (DB == 0) && (DC == 0))  dat00[0] |= 0x0020;
                    dat00[0x002D]=0;
                }
            }
            else if(dat00[0x0010] == 0x0021)
            {
                if(dat00[0x002D] >= DB)
                {
                    ...
                    if((dat00[0x37] > 0) && (DC == 0))  dat00[0] |= 0x0020;
                    dat00[0x002D]=0;
                }
            }
            else if(dat00[0x0010] == 0x0022)
            {
                if(dat00[0x002D] >= DC)
                {
                    ...
                    dat00_flag[0x10]=1;
                    dat00[0x002D]=0;
                    if((dat00[0x37] > 0))  dat00[0] |= 0x0020;
                }
            }
