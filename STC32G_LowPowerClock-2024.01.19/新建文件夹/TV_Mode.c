...
void TVMode_int()
{
    ...
    yue_ri(0,(u8)((Time_New[6]/16*10) + (Time_New[6]%16)),0);//

    ZF_8X16(16,0,22);

    yue_ri(21,(u8)((Time_New[5]/16*10) + (Time_New[5]%16)),0);//

    ZF_8X16(37,0,22);

    yue_ri(43,(u8)((Time_New[4]/16*10) + (Time_New[4]%16)),0);//

    ZF_8X16(63,0,Week_conversion());
...
void TVMode_1()
{
    ...
    if(dat & 0x0010)
    {
        if((Time_Low[2]/16) == 2)
        {
            shifen_dh(24,3,(33 - dat00[0x12] + (Time_Low[2]%16)*32),20);
        }
        else
        {
    ...
    if(dat & 0x0020)
    {
        shifen_dh(8,3,(33 - dat00[0x12] + (Time_Low[2]/16)*32),8);
    }
    if(dat & 0x0040)
    {
        ZF_8X16(88,0,Week_conversion());
    }
    if(dat & 0x0080)
    {
        yue_ri(64,(u8)((Time_New[4]/16*10) + (Time_New[4]%16)),0);//
    }
    if(dat & 0x0100)
    {
        yue_ri(40,(u8)((Time_New[5]/16*10) + (Time_New[5]%16)),1);//
    }
    if(dat & 0x0200)
    {
        nian(2000 + (Time_New[6]/16*10) + (Time_New[6]%16),0);
    }
}
