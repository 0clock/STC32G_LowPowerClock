...
void ZF_8X16(u8 x,u8 y,u8 ee)//
{
    ...
    for(i=0; i<16; i++)
    {
        OLED_WrDat(F8x16[ee][i]);
        if(i==7) OLED_Set_Pos(x,(u8)(y+1));
    }
}
...
void OLED_32X32(u8 x,u8 y,u8 adde,u8 devia1,u8 devia2)
{
    unsigned char i = 0;
    unsigned char j = 0;
