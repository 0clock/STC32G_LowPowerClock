...
{
    IIC_W2bit(0x22,0x4b,0x81);// 0x01 休眠模式 0x80 软复位
...
//		if(Judging_Range(dat00[0x0068],JD_low,10))
//		{
//			dat00[0x0068] = (u16)Get_Magnetism_dat(Magnetism_JD,dat00[0x0068],5);
//			dat00[0x0068] = (u16)Get_Magnetism_dat(Magnetism_JD1,dat00[0x0068],5);
//		}
//		else
//		{
//		   for(a=0;a<5;a++)
//			 {
//				 Magnetism_JD[a] = dat00[0x0068];
//				 Magnetism_JD1[a] = dat00[0x0068];
//			 }	
//		}
//		JD_low = dat00[0x0068];
    //dat00[0x0068] = (u16)Get_Magnetism_dat(Magnetism_JD,convert_1(dat00[0x0068]));



//		b = Abs_Difference_16(JD_low,dat00[0x0068]);
//		if(b>180) b = 360 - b;//b = 0~180
//		b =  b/16;
//		b = 11 - b;
//		
