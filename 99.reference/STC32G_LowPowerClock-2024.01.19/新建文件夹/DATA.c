...
//8时间设置寄存器组
    0xff,0x000F,0x000F,0x000E,0x0010,0x0012,0x0011,0x0013,0x00ff,0,0,0,0,0,0,0,
...
u8 xdata Time_int[7] = {0x50,0x30,0x09,0x02,0x27,0x02,0x23};
...
void GET_time_c()
{
    dat00[0x0081] = BCD_to_X10(Time_New[0]);
    dat00[0x0082] = BCD_to_X10(Time_New[1]);
    dat00[0x0083] = BCD_to_X10(Time_New[2]);
    dat00[0x0085] = BCD_to_X10(Time_New[4]);
    dat00[0x0086] = BCD_to_X10(Time_New[5]);
    dat00[0x0087] = BCD_to_X10(Time_New[6]);
...
void SET_time_c()
{
    Time_int[0] = X10_to_BCD(dat00[0x0081]);
    Time_int[1] = X10_to_BCD(dat00[0x0082]);
    Time_int[2] = X10_to_BCD(dat00[0x0083]);
		Time_int[3] = SET_WEEK(dat00[0x0084]);
    Time_int[4] = X10_to_BCD(dat00[0x0085]);
    Time_int[5] = X10_to_BCD(dat00[0x0086]);
    Time_int[6] = X10_to_BCD(dat00[0x0087]);
    //dat00[0x0084] = GET_WEEK(Time_New[3]);
}
