...
//========================================================================
// 函数: Get_Magnetism_dat(int *dat1,u16 dat,u8 num)
// 描述: 求平均值，滤波
// 参数: 
// 返回: 
// 版本: V1.0 2023.02.05
...
void Magnetometer_initi()
{
    IIC_W2bit(0x22,0x4b,0x01);// 0x01 休眠模式 0x80 软复位
	  Sleep_delay_Time(20);//等待很重要，不然挂起不了
...
//========================================================================
// 函数: Atan算法   感谢红石电路吧  吧友KAAAsS（星星打不出来）公开的【CORDIC算法】思路
// 描述: 
// 参数: 
// 返回: 
// 版本: V1.0 2023.02.05
...
//========================================================================
// 函数: void Angle_calculation(int x1,int y1)
// 描述: 做了一些象限的判断，映射在0~360度
// 参数: 
// 返回: 
// 版本: V1.0 2023.02.05
//========================================================================
...
//========================================================================
// 函数: u16 Magnetometer_measure_1(u8 aa,bit b)
// 描述: 读取传感器数据
// 参数: 
// 返回: 
// 版本: V1.0 2023.02.05
//========================================================================
u16 Magnetometer_measure_1(u8 aa,bit b)
{
    u8 a = 0;
    u16 c = 0;
    a = RecvData();                             //读取数据2
...
//    u8 a = 0;
    ...
    dat00[0x0060] = (u16)convert_1(dat00[0x0060]);//看得我有点迷惑，但没敢动
...
//========================================================================
// 函数: void Magnetometer_falg_0080()
// 描述: 指南针任务
// 参数: 
// 返回: 
// 版本: V1.0 2023.02.05
